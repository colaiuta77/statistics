...
![BookOasis 통계 대시보드](docs/statistics-dashboard-overview.png?v=1.2.0)

![BookOasis 통계 상세 화면](docs/statistics-dashboard-detail.png?v=1.2.0)
...
`도서 읽은 날` 카드는 드래그 대상에서 제외되어 항상 맨 아래에 표시됩니다. [ECharts Calendar Heatmap 예제](https://echarts.apache.org/examples/en/editor.html?c=calendar-heatmap)처럼 하루 칸 높이를 13px로 유지하고, 올해 1~12월을 가로로 펼칩니다. 좁은 화면에서는 달력 안에서 좌우로 스크롤할 수 있습니다.
